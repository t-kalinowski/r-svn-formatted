...
int F77_SYMBOL(zsico)(complex *a, int *lda, int *n, int *kpvt, double *rcond, complex *z)
{
    ...
    {
        i__2 = j;
        d__1 = anorm, d__2 = z[i__2].r;
        anorm = max(d__1, d__2);
    }

    /* factor */

    F77_SYMBOL(zsifa)(&a[a_offset], lda, n, &kpvt[1], &info);
...
L80:
    ...
    if ((d__1 = z[i__1].r, abs(d__1)) + (d__2 = z__1.r, abs(d__2)) <=
        (d__3 = a[i__3].r, abs(d__3)) + (d__4 = z__2.r, abs(d__4)))
    {
        goto L90;
    }
    i__1 = k + k * a_dim1;
    ...
    s = ((d__1 = a[i__1].r, abs(d__1)) + (d__2 = z__1.r, abs(d__2))) /
        ((d__3 = z[i__3].r, abs(d__3)) + (d__4 = z__2.r, abs(d__4)));
...
L130:
    ...
    i__2 = k;
    i__3 = k - 1;
    F77_SYMBOL(zdotu)(&z__2, &i__3, &a[k * a_dim1 + 1], &c__1, &z[1], &c__1);
    ...
    if (ks == 2)
    {
        ...
        i__2 = k + 1;
        i__3 = k - 1;
        F77_SYMBOL(zdotu)(&z__2, &i__3, &a[(k + 1) * a_dim1 + 1], &c__1, &z[1], &c__1);
        z__1.r = z[i__2].r + z__2.r;
        z__1.i = z[i__2].i + z__2.i;
        z[i__1].r = z__1.r;
        z[i__1].i = z__1.i;
