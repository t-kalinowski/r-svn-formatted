...
extern longint F77_NAME(dqrdc2)(double *, longint *, longint *, longint *, double *, longint *, double *, longint *,
                                double *);

/* These are based on the argument
   sequences used in the nlme 2.1 code
   on statlib. */
void F77_NAME(dqrdca)(double *x, longint *ldx, longint *n, longint *p, double *qraux, longint *jpvt, double *work,
