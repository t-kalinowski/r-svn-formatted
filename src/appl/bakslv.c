...
/* Subroutine */ int bkslv_(doublereal *t, integer *ldt, integer *n, doublereal *b, integer *ldb, doublereal *x,
                            integer *job, integer *info)
{
    ...
    /* Local variables */
    static integer j;
    extern /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, doublereal *, integer *),
        dtrsl_(doublereal *, integer *, integer *, doublereal *, integer *, integer *);
