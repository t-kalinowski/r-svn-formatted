...
static void rdqagie(integr_fn f, void *ex, double *, int *, double *, double *, int *, double *, double *, int *, int *,
                    double *, double *, double *, double *, int *, int *);

static void rdqk15i(integr_fn f, void *ex, double *, int *, double *, double *, double *, double *, double *, double *);

static void rdqagse(integr_fn f, void *ex, double *, double *, double *, double *, int *, double *, double *, int *,
                    int *, double *, double *, double *, double *, int *, int *);

static void rdqk21(integr_fn f, void *ex, double *, double *, double *, double *, double *, double *);
...
void Rdqagi(integr_fn f, void *ex, double *bound, int *inf, double *epsabs, double *epsrel, double *result,
            double *abserr, int *neval, int *ier, int *limit, int *lenw, int *last, int *iwork, double *work)
{
    ...
    *abserr = 0.;
    ...
    rdqagie(f, ex, bound, inf, epsabs, epsrel, limit, result, abserr, neval, ier, &work[1], &work[l1], &work[l2],
            &work[l3], &iwork[1], last);

    return;
} /* Rdqagi */

static void rdqagie(integr_fn f, void *ex, double *bound, int *inf, double *epsabs, double *epsrel, int *limit,
                    double *result, double *abserr, int *neval, int *ier, double *alist__, double *blist, double *rlist,
                    double *elist, int *iord, int *last)
{
    ...
    *abserr = oflow;
    ...
    for (*last = 2; *last <= *limit; ++(*last))
    {
        ...
        if (fabs(rlist[maxerr] - area12) > fabs(area12) * 1e-5 || erro12 < errmax * .99)
        {
            goto L10;
        }
        if (extrap)
    ...
    L15:
        ...
        if (fmax2(fabs(a1), fabs(b2)) <= (epmach * 100. + 1.) * (fabs(a2) + uflow * 1e3))
        {
            *ier = 4;
        }
...
void Rdqags(integr_fn f, void *ex, double *a, double *b, double *epsabs, double *epsrel, double *result, double *abserr,
            int *neval, int *ier, int *limit, int *lenw, int *last, int *iwork, double *work)
{
    ...
    *abserr = 0.;
    ...
    rdqagse(f, ex, a, b, epsabs, epsrel, limit, result, abserr, neval, ier, &work[1], &work[l1], &work[l2], &work[l3],
            &iwork[1], last);

    return;
} /* rdqags_ */

static void rdqagse(integr_fn f, void *ex, double *a, double *b, double *epsabs, double *epsrel, int *limit,
                    double *result, double *abserr, int *neval, int *ier, double *alist__, double *blist, double *rlist,
                    double *elist, int *iord, int *last)
{
    /* Local variables */
...
static void rdqk15i(integr_fn f, void *ex, double *boun, int *inf, double *a, double *b, double *result, double *abserr,
...
static void rdqk21(integr_fn f, void *ex, double *a, double *b, double *result, double *abserr, double *resabs,
                   double *resasc)
{
    /* Initialized data */
