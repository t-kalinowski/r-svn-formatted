...
#endif
{
    ...
    if (strcmp(locale, "chs") == 0)
        locale = "zh_CN";
    if (strcmp(locale, "chinese") == 0)
        locale = "zh_TW";
    if (strcmp(locale, "cht") == 0)
        locale = "zh_TW";
    if (strcmp(locale, "ptb") == 0)
        locale = "pt_BR";
    if (strcmp(locale, "german") == 0)
        locale = "de_DE";
    ...
    if (strncmp(locale, "ko", 2) == 0)
        locale = "ko_KO";
    if (strcmp(locale, "jpn") == 0)
        locale = "ja_JP";
    if (strncmp(locale, "rus", 3) == 0)
        locale = "ru_RU";
    if (strcmp(locale, "spanish") == 0)
        locale = "es_ES";
#endif
#endif
#endif
