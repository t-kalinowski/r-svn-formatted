...
#undef PRIdPTR
#define PRIdPTR (sizeof(void *) == sizeof(long) ? "ld" : sizeof(void *) == sizeof(int) ? "d" : "lld")
#endif
#if !defined PRIiPTR || PRI_MACROS_BROKEN
#undef PRIiPTR
#define PRIiPTR (sizeof(void *) == sizeof(long) ? "li" : sizeof(void *) == sizeof(int) ? "i" : "lli")
#endif
#if !defined PRIoPTR || PRI_MACROS_BROKEN
#undef PRIoPTR
#define PRIoPTR (sizeof(void *) == sizeof(long) ? "lo" : sizeof(void *) == sizeof(int) ? "o" : "llo")
#endif
#if !defined PRIuPTR || PRI_MACROS_BROKEN
#undef PRIuPTR
#define PRIuPTR (sizeof(void *) == sizeof(long) ? "lu" : sizeof(void *) == sizeof(int) ? "u" : "llu")
#endif
#if !defined PRIxPTR || PRI_MACROS_BROKEN
#undef PRIxPTR
#define PRIxPTR (sizeof(void *) == sizeof(long) ? "lx" : sizeof(void *) == sizeof(int) ? "x" : "llx")
#endif
#if !defined PRIXPTR || PRI_MACROS_BROKEN
#undef PRIXPTR
#define PRIXPTR (sizeof(void *) == sizeof(long) ? "lX" : sizeof(void *) == sizeof(int) ? "X" : "llX")
...
const char *internal_function _nl_init_domain_conv(struct loaded_l10nfile *domain_file, struct loaded_domain *domain,
...
void internal_function _nl_load_domain(struct loaded_l10nfile *domain_file, struct binding *domainbinding)
{
    ...
    case 1:
        ...
        domain->hash_tab =
            (domain->hash_size > 2 ? (const nls_uint32 *)((char *)data + W(domain->must_swap, data->hash_tab_offset))
                                   : NULL);
        ...
        default: {
            ...
            if (n_sysdep_strings > 0)
            {
                ...
                sysdep_segments =
                    (const struct sysdep_segment *)((char *)data + W(domain->must_swap, data->sysdep_segments_offset));
                ...
                orig_sysdep_tab =
                    (const nls_uint32 *)((char *)data + W(domain->must_swap, data->orig_sysdep_tab_offset));
                trans_sysdep_tab =
                    (const nls_uint32 *)((char *)data + W(domain->must_swap, data->trans_sysdep_tab_offset));
                ...
                for (i = 0; i < n_sysdep_strings; i++)
                {
                    ...
                    for (j = 0; j < 2; j++)
                    {
                        const struct sysdep_string *sysdep_string =
                            (const struct sysdep_string *)((char *)data +
                                                           W(domain->must_swap,
                    ...
                    for (i = 0; i < n_sysdep_strings; i++)
                    {
                        ...
                        if (valid)
                        {
                            for (j = 0; j < 2; j++)
                            {
                                const struct sysdep_string *sysdep_string =
                                    (const struct sysdep_string *)((char *)data +
                                                                   W(domain->must_swap, j == 0 ? orig_sysdep_tab[i]
                                                                                               : trans_sysdep_tab[i]));
...
#ifdef _LIBC
void internal_function _nl_unload_domain(struct loaded_domain *domain)
{
