...
#define mmap(addr, len, prot, flags, fd, offset) __mmap(addr, len, prot, flags, fd, offset)
...
#ifdef _LIBC
void internal_function __libc_freeres_fn_section _nl_unload_domain(struct loaded_domain *domain)
{
    size_t i;
