...
void _nl_locale_name_canonicalize(char *name)
{
    ...
    static const legacy_entry legacy_table[] = {{"Afrikaans", "af"},
                                                {"Albanian", "sq"},
                                                {"Amharic", "am"},
                                                {"Arabic", "ar"},
                                                {"Armenian", "hy"},
    ...
    static const langtag_entry langtag_table[] = {/* MacOS X has "az-Arab", "az-Cyrl", "az-Latn".
    ...
    static const script_entry script_table[] = {{"Arab", "arabic"}, {"Cyrl", "cyrillic"}, {"Mong", "mongolian"}};
...
const char *_nl_locale_name_default(void)
{
    ...
    /* MacOS X 10.2 or newer */
    {
        ...
        if (cached_localename == NULL)
        {
            ...
            CFTypeRef value = CFPreferencesCopyAppValue(CFSTR("AppleLocale"), kCFPreferencesCurrentApplication);
