                       ...
                       sprintf.  */
                    {
                        ...
                        case 'u':
                            ...
                            if (type == TYPE_LONGLONGINT || type == TYPE_ULONGLONGINT)
                                tmp_length = (unsigned int)(sizeof(unsigned long long) * CHAR_BIT *
                                ...
                                tmp_length =
                                    (unsigned int)(sizeof(unsigned long) * CHAR_BIT * 0.30103 /* binary -> decimal */
                                                   * 2 /* estimate for FLAG_GROUP */
                                                   ) +
                                    1    /* turn floor into ceil */
                                    + 1; /* account for leading sign */
                                ...
                                tmp_length =
                                    (unsigned int)(sizeof(unsigned int) * CHAR_BIT * 0.30103 /* binary -> decimal */
                                                   * 2 /* estimate for FLAG_GROUP */
                                                   ) +
                                    1    /* turn floor into ceil */
                                    + 1; /* account for leading sign */
                        ...
                        case 'o':
                            ...
                            if (type == TYPE_LONGLONGINT || type == TYPE_ULONGLONGINT)
                                ...
                                if (type == TYPE_LONGINT || type == TYPE_ULONGINT)
                                tmp_length =
                                    (unsigned int)(sizeof(unsigned long) * CHAR_BIT * 0.333334 /* binary -> octal */
                                                   ) +
                                    1    /* turn floor into ceil */
                                    + 1; /* account for leading sign */
                            else
                                tmp_length =
                                    (unsigned int)(sizeof(unsigned int) * CHAR_BIT * 0.333334 /* binary -> octal */
                                                   ) +
                                    1    /* turn floor into ceil */
                                    + 1; /* account for leading sign */
                            break;
                        ...
                        case 'X':
                            ...
                            if (type == TYPE_LONGLONGINT || type == TYPE_ULONGLONGINT)
                                ...
                                if (type == TYPE_LONGINT || type == TYPE_ULONGINT)
                                tmp_length =
                                    (unsigned int)(sizeof(unsigned long) * CHAR_BIT * 0.25 /* binary -> hexadecimal */
                                                   ) +
                                    1    /* turn floor into ceil */
                                    + 2; /* account for leading sign or alternate form */
                            else
                        ...
                        case 's':
                            ...
                            {
                                tmp_length = local_wcslen(a.arg[dp->arg_index].a.a_wide_string);
...
#define SNPRINTF_BUF(arg)                                                                                              \
    ...
    case 1:                                                                                                            \
        ...
        break;                                                                                                         \
    case 2:                                                                                                            \
        count = sprintf(tmp, buf, prefixes[0], prefixes[1], arg);                                                      \
        break;                                                                                                         \
    default:                                                                                                           \
        abort();                                                                                                       \
    }
                                ...
                                if (retcount < 0)
                                {
                                    /* HP-UX 10.20 snprintf() is doubly deficient:
                                       ...
                                       *and* it returns -1 (rather than the length
                                       ...
                                       buffer is too small.  */
                                    size_t bigger_need = xsum(xtimes(allocated, 2), 12);
