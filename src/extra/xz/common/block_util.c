...
extern LZMA_API(lzma_ret) lzma_block_compressed_size(lzma_block *block, lzma_vli total_size)
{
...
extern LZMA_API(lzma_vli) lzma_block_unpadded_size(const lzma_block *block)
{
    ...
    if (block == NULL || block->version != 0 || block->header_size < LZMA_BLOCK_HEADER_SIZE_MIN ||
