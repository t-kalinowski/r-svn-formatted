...
extern lzma_ret lzma_index_encoder_init(lzma_next_coder *next, lzma_allocator *allocator, const lzma_index *i)
{
...
extern LZMA_API(lzma_ret) lzma_index_buffer_encode(const lzma_index *i, uint8_t *out, size_t *out_pos, size_t out_size)
{
