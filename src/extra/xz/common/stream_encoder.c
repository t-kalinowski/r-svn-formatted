...
static lzma_ret stream_encode(lzma_coder *coder, lzma_allocator *allocator, const uint8_t *restrict in,
                              ...
                              size_t out_size, lzma_action action)
{
    ...
    while (*out_pos < out_size)
        ...
        case SEQ_BLOCK_ENCODE: {
            ...
            const lzma_ret ret = coder->block_encoder.code(coder->block_encoder.coder, allocator, in, in_pos, in_size,
        ...
        case SEQ_INDEX_ENCODE: {
            ...
            const lzma_ret ret = coder->index_encoder.code(coder->index_encoder.coder, allocator, NULL, NULL, 0, out,
...
static lzma_ret stream_encoder_update(lzma_coder *coder, lzma_allocator *allocator, const lzma_filter *filters,
...
extern lzma_ret lzma_stream_encoder_init(lzma_next_coder *next, lzma_allocator *allocator, const lzma_filter *filters,
                                         lzma_check check)
{
    ...
    return_if_error(lzma_stream_header_encode(&stream_flags, next->coder->buffer));
    ...
    return stream_encoder_update(next->coder, allocator, filters, NULL);
}
