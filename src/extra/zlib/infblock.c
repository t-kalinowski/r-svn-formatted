...
inflate_blocks_statef *inflate_blocks_new(z, c, w) z_streamp z;
check_func c;
uInt w;
{
...
int inflate_blocks(s, z, r) inflate_blocks_statef *s;
z_streamp z;
int r;
{
...
int inflate_blocks_free(s, z) inflate_blocks_statef *s;
z_streamp z;
{
    inflate_blocks_reset(s, z, Z_NULL);
    ZFREE(z, s->window);
 ...
 */
int inflate_blocks_sync_point(s) inflate_blocks_statef *s;
{
    return s->mode == LENS;
}
