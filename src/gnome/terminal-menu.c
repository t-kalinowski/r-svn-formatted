...
static void help_about_cb(GtkWidget *widget, gpointer data)
{
    ...
    about_box =
        gnome_about_new("R", version, copyright, authors,
                        "R is a system for statistical computation and graphics.  It is a dialect of the S programming "
                        "language from Bell Labs.  R is free software and comes with ABSOLUTELY NO WARRANTY.",
                        "R-logo-sm.xpm");
...
static GnomeUIInfo file_menu[] = {GNOMEUIINFO_SUBTREE("_Workspace", file_ws_menu),
                                  GNOMEUIINFO_SUBTREE("_Data", file_data_menu),
                                  GNOMEUIINFO_SEPARATOR,
                                  {GNOME_APP_UI_ITEM, "_Print...", "Print the console output", generic_cb, NULL, NULL,
                                   GNOME_APP_PIXMAP_STOCK, GNOME_STOCK_MENU_PRINT, NULL, (GdkModifierType)0, NULL},
...
static GnomeUIInfo commands_menu[] = {{GNOME_APP_UI_ITEM, "_Interrupt", "Interrupt R processing (SIGTERM)",
                                       commands_interrupt_cb, NULL, NULL, GNOME_APP_PIXMAP_NONE, NULL, GDK_Escape,
