...
GtkWidget *prefs_text_page(void)
{
    ...
    gnome_font_picker_set_font_name(GNOME_FONT_PICKER(font_picker), gtk_entry_get_text(GTK_ENTRY(font_entry)));
    gnome_font_picker_set_mode(GNOME_FONT_PICKER(font_picker), GNOME_FONT_PICKER_MODE_USER_WIDGET);
    font_picker_label = gtk_label_new("Browse...");
    gnome_font_picker_uw_set_widget(GNOME_FONT_PICKER(font_picker), font_picker_label);

    gtk_table_attach(GTK_TABLE(table), font_label, 0, 1, 0, 1, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(table), font_entry, 1, 2, 0, 1, GTK_FILL, 0, 0, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(table), font_picker, 2, 3, 0, 1, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);

    gtk_signal_connect(GTK_OBJECT(font_entry), "changed", GTK_SIGNAL_FUNC(prefs_font_entry_changed),
                       (gpointer)&R_gnome_newprefs.font);
    gtk_signal_connect(GTK_OBJECT(font_picker), "font_set", GTK_SIGNAL_FUNC(prefs_font_picker_font_set),
                       (gpointer)&R_gnome_newprefs.font);
    ...
    gnome_color_picker_set_i16(GNOME_COLOR_PICKER(textcol_button), R_gnome_userprefs.textcolor.red,
                               R_gnome_userprefs.textcolor.green, R_gnome_userprefs.textcolor.blue, 0);

    gtk_table_attach(GTK_TABLE(table), textcol_label, 0, 1, 1, 2, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(table), textcol_button, 1, 2, 1, 2, 0, 0, 0, GNOME_PAD_SMALL);

    gtk_signal_connect(GTK_OBJECT(textcol_button), "color_set", GTK_SIGNAL_FUNC(prefs_text_color_set), NULL);
    ...
    gnome_color_picker_set_i16(GNOME_COLOR_PICKER(bgcol_button), R_gnome_userprefs.bgcolor.red,
                               R_gnome_userprefs.bgcolor.green, R_gnome_userprefs.bgcolor.blue, 0);

    gtk_table_attach(GTK_TABLE(table), bgcol_label, 0, 1, 2, 3, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(table), bgcol_button, 1, 2, 2, 3, 0, 0, 0, GNOME_PAD_SMALL);

    gtk_signal_connect(GTK_OBJECT(bgcol_button), "color_set", GTK_SIGNAL_FUNC(prefs_bg_color_set), NULL);
...
GtkWidget *prefs_workspace_frame(void)
{
    ...
    gtk_table_attach(GTK_TABLE(table), ask, 0, 2, 0, 1, GTK_FILL, 0, GNOME_PAD, 0);
    gtk_table_attach(GTK_TABLE(table), save, 0, 2, 1, 2, GTK_FILL, 0, GNOME_PAD, 0);
    gtk_table_attach(GTK_TABLE(table), savetofile, 0, 2, 2, 3, GTK_FILL, 0, GNOME_PAD, 0);
    gtk_table_attach(GTK_TABLE(table), dummy, 0, 1, 3, 4, GTK_FILL, 0, GNOME_PAD_BIG, 0);
    gtk_table_attach(GTK_TABLE(table), nameentry, 1, 2, 3, 4, GTK_FILL, 0, 0, 0);
    gtk_table_attach(GTK_TABLE(table), dontsave, 0, 2, 4, 5, GTK_FILL, 0, GNOME_PAD, GNOME_PAD_SMALL);
...
GtkWidget *prefs_history_frame(void)
{
    ...
    gtk_table_attach(GTK_TABLE(table), save, 0, 2, 0, 1, GTK_FILL, 0, GNOME_PAD, 0);
    gtk_table_attach(GTK_TABLE(table), savewithws, 0, 2, 1, 2, GTK_FILL, 0, GNOME_PAD, 0);
    gtk_table_attach(GTK_TABLE(table), dontsave, 0, 2, 2, 3, GTK_FILL, 0, GNOME_PAD, 0);
...
GtkWidget *prefs_startup_page(void)
{
    ...
    gtk_table_attach(GTK_TABLE(table), vsize_label, 0, 1, 0, 1, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(table), vsize_entry, 1, 2, 0, 1, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    ...
    gtk_table_attach(GTK_TABLE(table), nsize_label, 0, 1, 1, 2, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(table), nsize_entry, 1, 2, 1, 2, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    ...
    gtk_table_attach(GTK_TABLE(table), warning_label, 0, 2, 2, 3, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
...
GtkWidget *prefs_pager_page(void)
{
    ...
    gnome_font_picker_set_font_name(GNOME_FONT_PICKER(tfont_picker), gtk_entry_get_text(GTK_ENTRY(tfont_entry)));
    gnome_font_picker_set_mode(GNOME_FONT_PICKER(tfont_picker), GNOME_FONT_PICKER_MODE_USER_WIDGET);
    tfont_picker_label = gtk_label_new("Browse...");
    gnome_font_picker_uw_set_widget(GNOME_FONT_PICKER(tfont_picker), tfont_picker_label);

    gtk_table_attach(GTK_TABLE(title_table), tfont_label, 0, 1, 0, 1, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(title_table), tfont_entry, 1, 2, 0, 1, GTK_FILL, 0, 0, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(title_table), tfont_picker, 2, 3, 0, 1, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    ...
    gnome_color_picker_set_i16(GNOME_COLOR_PICKER(ttextcol_button), R_gnome_userprefs.textcolor.red,
                               R_gnome_userprefs.textcolor.green, R_gnome_userprefs.textcolor.blue, 0);

    gtk_table_attach(GTK_TABLE(title_table), ttextcol_label, 0, 1, 1, 2, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(title_table), ttextcol_button, 1, 2, 1, 2, 0, 0, 0, GNOME_PAD_SMALL);
    ...
    gnome_color_picker_set_i16(GNOME_COLOR_PICKER(tbgcol_button), R_gnome_userprefs.bgcolor.red,
                               R_gnome_userprefs.bgcolor.green, R_gnome_userprefs.bgcolor.blue, 0);

    gtk_table_attach(GTK_TABLE(title_table), tbgcol_label, 0, 1, 2, 3, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(title_table), tbgcol_button, 1, 2, 2, 3, 0, 0, 0, GNOME_PAD_SMALL);
    ...
    gnome_font_picker_set_font_name(GNOME_FONT_PICKER(nfont_picker), gtk_entry_get_text(GTK_ENTRY(nfont_entry)));
    gnome_font_picker_set_mode(GNOME_FONT_PICKER(nfont_picker), GNOME_FONT_PICKER_MODE_USER_WIDGET);
    nfont_picker_label = gtk_label_new("Browse...");
    gnome_font_picker_uw_set_widget(GNOME_FONT_PICKER(nfont_picker), nfont_picker_label);

    gtk_table_attach(GTK_TABLE(text_table), nfont_label, 0, 1, 0, 1, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(text_table), nfont_entry, 1, 2, 0, 1, GTK_FILL, 0, 0, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(text_table), nfont_picker, 2, 3, 0, 1, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    ...
    gnome_font_picker_set_font_name(GNOME_FONT_PICKER(emfont_picker), gtk_entry_get_text(GTK_ENTRY(emfont_entry)));
    gnome_font_picker_set_mode(GNOME_FONT_PICKER(emfont_picker), GNOME_FONT_PICKER_MODE_USER_WIDGET);
    emfont_picker_label = gtk_label_new("Browse...");
    gnome_font_picker_uw_set_widget(GNOME_FONT_PICKER(emfont_picker), emfont_picker_label);

    gtk_table_attach(GTK_TABLE(text_table), emfont_label, 0, 1, 1, 2, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(text_table), emfont_entry, 1, 2, 1, 2, GTK_FILL, 0, 0, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(text_table), emfont_picker, 2, 3, 1, 2, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    ...
    gnome_color_picker_set_i16(GNOME_COLOR_PICKER(ntextcol_button), R_gnome_userprefs.textcolor.red,
                               R_gnome_userprefs.textcolor.green, R_gnome_userprefs.textcolor.blue, 0);

    gtk_table_attach(GTK_TABLE(text_table), ntextcol_label, 0, 1, 2, 3, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(text_table), ntextcol_button, 1, 2, 2, 3, 0, 0, 0, GNOME_PAD_SMALL);
    ...
    gnome_color_picker_set_i16(GNOME_COLOR_PICKER(nbgcol_button), R_gnome_userprefs.bgcolor.red,
                               R_gnome_userprefs.bgcolor.green, R_gnome_userprefs.bgcolor.blue, 0);

    gtk_table_attach(GTK_TABLE(text_table), nbgcol_label, 0, 1, 3, 4, GTK_FILL, 0, GNOME_PAD_SMALL, GNOME_PAD_SMALL);
    gtk_table_attach(GTK_TABLE(text_table), nbgcol_button, 1, 2, 3, 4, 0, 0, 0, GNOME_PAD_SMALL);
...
void settings_prefs_cb(GtkWidget *widget, gpointer data)
{
    ...
    gnome_property_box_append_page(GNOME_PROPERTY_BOX(prefs_dialog), page0, label0);
    gnome_property_box_append_page(GNOME_PROPERTY_BOX(prefs_dialog), page1, label1);
    gnome_property_box_append_page(GNOME_PROPERTY_BOX(prefs_dialog), page2, label2);
    gnome_property_box_append_page(GNOME_PROPERTY_BOX(prefs_dialog), page3, label3);
    gnome_property_box_append_page(GNOME_PROPERTY_BOX(prefs_dialog), page4, label4);
    gnome_property_box_append_page(GNOME_PROPERTY_BOX(prefs_dialog), page5, label5);

    /* Connect to property box signal */
    gtk_signal_connect(GTK_OBJECT(prefs_dialog), "apply", GTK_SIGNAL_FUNC(prefs_apply_cb), NULL);

    /* Setup dialog features */
    gnome_dialog_set_parent(GNOME_DIALOG(prefs_dialog), GTK_WINDOW(R_gtk_main_window));
