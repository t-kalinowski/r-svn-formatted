...
void R_gtk_terminal_new()
{
    ...
    gtk_table_attach(GTK_TABLE(table), R_gtk_terminal_text, 0, 1, 0, 1, GTK_EXPAND | GTK_SHRINK | GTK_FILL,
...
void R_gnome_load_prefs(void)
{
    ...
    R_gnome_userprefs.pager_title_font =
    ...
    R_gnome_userprefs.pager_text_font =
        gnome_config_get_string("text_font=-misc-fixed-medium-r-normal-*-*-120-*-*-c-*-iso8859-1");
    R_gnome_userprefs.pager_em_font =
        gnome_config_get_string("em_font=-misc-fixed-bold-r-normal-*-*-120-*-*-c-*-iso8859-1");
...
void R_gnome_save_prefs(void)
{
    ...
    gnome_config_set_string("textcolor", g_strdup_printf("rgb:%04x/%04x/%04x", tmp.red, tmp.green, tmp.blue));
    tmp = R_gnome_userprefs.bgcolor;
    gnome_config_set_string("bgcolor", g_strdup_printf("rgb:%04x/%04x/%04x", tmp.red, tmp.green, tmp.blue));
    ...
    gnome_config_set_string("title_textcolor", g_strdup_printf("rgb:%04x/%04x/%04x", tmp.red, tmp.green, tmp.blue));
    tmp = R_gnome_userprefs.pager_title_bgcolor;
    gnome_config_set_string("title_bgcolor", g_strdup_printf("rgb:%04x/%04x/%04x", tmp.red, tmp.green, tmp.blue));
    ...
    gnome_config_set_string("text_textcolor", g_strdup_printf("rgb:%04x/%04x/%04x", tmp.red, tmp.green, tmp.blue));
    tmp = R_gnome_userprefs.pager_text_bgcolor;
    gnome_config_set_string("text_bgcolor", g_strdup_printf("rgb:%04x/%04x/%04x", tmp.red, tmp.green, tmp.blue));
