...
#define BMPERROR                                                                                                       \
    {                                                                                                                  \
        R_ShowMessage("Problems writing to 'bmp' file");                                                               \
        return 0;                                                                                                      \
    }
#define BMPW(a)                                                                                                        \
    {                                                                                                                  \
...
#define BMPLONG(a)                                                                                                     \
    {                                                                                                                  \
        lng = a;                                                                                                       \
        if (fwrite(&lng, sizeof(long), 1, fp) != 1)                                                                    \
            BMPERROR                                                                                                   \
    }
#define BMPPUTC(a)                                                                                                     \
    if (fputc(a, fp) == EOF)                                                                                           \
...
int R_SaveAsBmp(void *d, int width, int height, unsigned long (*gp)(void *, int, int), int bgr, FILE *fp)
{
    unsigned long col, palette[256];
    int i, j, r, ncols, mid, high, low, withpalette;
