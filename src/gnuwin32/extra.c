...
SEXP do_chooseFiles(SEXP call, SEXP op, SEXP args, SEXP rho)
{
    ...
    *list = '\0'; /* no initialization */
    askfilenames(translateChar(STRING_ELT(caption, 0)), path, multi, cfilters, filterindex, list, 65500,
                 NULL); /* list declared larger to protect against overwrites */
    ...
    case 0:
        break;
    case 1:
        SET_STRING_ELT(ans, 0, mkChar(list));
        break;
    default:
