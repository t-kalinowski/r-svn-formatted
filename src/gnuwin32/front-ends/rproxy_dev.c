...
static void R_Proxy_Graphics_Circle_CB(double x, double y, double r, pGEcontext gc, R_Proxy_Graphics_CB *dd);
...
static void R_Proxy_Graphics_Line_CB(double x1, double y1, double x2, double y2, pGEcontext gc,
                                     R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_MetricInfo_CB(int c, pGEcontext gc, double *ascent, double *descent, double *width,
                                           R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Mode_CB(int mode, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_NewPage_CB(pGEcontext gc, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Polygon_CB(int n, double *x, double *y, pGEcontext gc, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Polyline_CB(int n, double *x, double *y, pGEcontext gc, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Rect_CB(double x0, double y0, double x1, double y1, pGEcontext gc,
                                     R_Proxy_Graphics_CB *dd);
...
#endif
static double R_Proxy_Graphics_StrWidth_CB(char *str, pGEcontext gc, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Text_CB(double x, double y, char *str, double rot, double hadj, pGEcontext gc,
                                     R_Proxy_Graphics_CB *dd);
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Circle_CB(double pX, double pY, double pRad, pGEcontext gc, R_Proxy_Graphics_CB *pDD)
{
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Line_CB(double pX0, double pY0, double pX1, double pY1, pGEcontext gc,
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_NewPage_CB(pGEcontext gc, R_Proxy_Graphics_CB *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Polygon_CB(int pCount, double *pX, double *pY, pGEcontext gc, R_Proxy_Graphics_CB *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Polyline_CB(int pCount, double *pX, double *pY, pGEcontext gc, R_Proxy_Graphics_CB *pDD)
{
    if (HASGFXDEV())
    {
        /* convert coordinates here: don't use alloca() -> overflow? */
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Rect_CB(double pX0, double pY0, double pX1, double pY1, pGEcontext gc,
                                     R_Proxy_Graphics_CB *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static double R_Proxy_Graphics_StrWidth_CB(char *pString, pGEcontext gc, R_Proxy_Graphics_CB *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Text_CB(double pX, double pY, char *pString, double pRot, double pHadj, pGEcontext gc,
                                     R_Proxy_Graphics_CB *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_MetricInfo_CB(int pC, pGEcontext gc, double *pAscent, double *pDescent, double *pWidth,
                                           R_Proxy_Graphics_CB *pDD)
{
    if (HASGFXDEV())
    {
...
static void R_Proxy_Graphics_Circle_Recorder(double x, double y, double r, pGEcontext gc,
...
static void R_Proxy_Graphics_Line_Recorder(double x1, double y1, double x2, double y2, pGEcontext gc,
                                           R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_MetricInfo_Recorder(int c, pGEcontext gc, double *ascent, double *descent, double *width,
                                                 R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Mode_Recorder(int mode, R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_NewPage_Recorder(pGEcontext gc, R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Polygon_Recorder(int n, double *x, double *y, pGEcontext gc,
                                              R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Polyline_Recorder(int n, double *x, double *y, pGEcontext gc,
                                               R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Rect_Recorder(double x0, double y0, double x1, double y1, pGEcontext gc,
                                           R_Proxy_Graphics_Recorder *dd);
...
#endif
static double R_Proxy_Graphics_StrWidth_Recorder(char *str, pGEcontext gc, R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Text_Recorder(double x, double y, char *str, double rot, double hadj, pGEcontext gc,
                                           R_Proxy_Graphics_Recorder *dd);
...
static void R_Proxy_Graphics_Circle_Recorder(double pX, double pY, double pRad, pGEcontext gc,
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Line_Recorder(double pX0, double pY0, double pX1, double pY1, pGEcontext gc,
                                           R_Proxy_Graphics_Recorder *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_NewPage_Recorder(pGEcontext gc, R_Proxy_Graphics_Recorder *pDD)
{
    if (HASGFXDEV())
    {
        GFXDEV()->vtbl->newpage(GFXDEV());
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Polygon_Recorder(int pCount, double *pX, double *pY, pGEcontext gc,
                                              R_Proxy_Graphics_Recorder *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Polyline_Recorder(int pCount, double *pX, double *pY, pGEcontext gc,
                                               R_Proxy_Graphics_Recorder *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_Rect_Recorder(double pX0, double pY0, double pX1, double pY1, pGEcontext gc,
                                           R_Proxy_Graphics_Recorder *pDD)
{
    if (HASGFXDEV())
    {
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static double R_Proxy_Graphics_StrWidth_Recorder(char *pString, pGEcontext gc, R_Proxy_Graphics_Recorder *pDD)
{
#if 0
  if(HASGFXDEV()) {
    int lSize = gc->cex * gc->ps + 0.5;
...
static void R_Proxy_Graphics_Text_Recorder(double pX, double pY, char *pString, double pRot, double pHadj,
                                           pGEcontext gc, R_Proxy_Graphics_Recorder *pDD)
{
    if (HASGFXDEV())
    {
        int lSize = gc->cex * gc->ps + 0.5;
...
/* 06-05-17 | baier | use GFX access macros */
/* 06-08-20 | baier | R_Proxy_Graphics instead of NewDevDesc, Recorder device */
static void R_Proxy_Graphics_MetricInfo_Recorder(int pC, pGEcontext gc, double *pAscent, double *pDescent,
