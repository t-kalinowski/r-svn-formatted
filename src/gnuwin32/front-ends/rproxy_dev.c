...
static void R_Proxy_Graphics_Line_CB(double x1, double y1, double x2, double y2, const pGEcontext gc,
...
static void R_Proxy_Graphics_NewPage_CB(const pGEcontext gc, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Polygon_CB(int n, double *x, double *y, const pGEcontext gc, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Polyline_CB(int n, double *x, double *y, const pGEcontext gc, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Rect_CB(double x0, double y0, double x1, double y1, const pGEcontext gc,
                                     R_Proxy_Graphics_CB *dd);
...
#endif
static double R_Proxy_Graphics_StrWidth_CB(char *str, const pGEcontext gc, R_Proxy_Graphics_CB *dd);
static void R_Proxy_Graphics_Text_CB(double x, double y, char *str, double rot, double hadj, const pGEcontext gc,
                                     R_Proxy_Graphics_CB *dd);
...
static void R_Proxy_Graphics_Circle_Recorder(double x, double y, double r, const pGEcontext gc,
...
static void R_Proxy_Graphics_Line_Recorder(double x1, double y1, double x2, double y2, const pGEcontext gc,
                                           R_Proxy_Graphics_Recorder *dd);
...
static void R_Proxy_Graphics_NewPage_Recorder(const pGEcontext gc, R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Polygon_Recorder(int n, double *x, double *y, const pGEcontext gc,
                                              R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Polyline_Recorder(int n, double *x, double *y, const pGEcontext gc,
                                               R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Rect_Recorder(double x0, double y0, double x1, double y1, const pGEcontext gc,
                                           R_Proxy_Graphics_Recorder *dd);
...
#endif
static double R_Proxy_Graphics_StrWidth_Recorder(char *str, const pGEcontext gc, R_Proxy_Graphics_Recorder *dd);
static void R_Proxy_Graphics_Text_Recorder(double x, double y, char *str, double rot, double hadj, const pGEcontext gc,
                                           R_Proxy_Graphics_Recorder *dd);
...
static void R_Proxy_Graphics_Circle_Recorder(double pX, double pY, double pRad, const pGEcontext gc,
