...
int R_Proxy_Graphics_Driver(pDevDesc pDD, char *pDisplay, double pWidth, double pHeight, double pPointSize);
...
static int R_Proxy_ReadConsole(const char *prompt, char *buf, int len, int addtohistory)
{
    return 0;
}
