...
static int PipeReadConsole(char *prompt, char *buf, int len, int addhistory)
{
    HANDLE rH;
    int id;
...
static void FileWriteConsole(char *buf, int len)
{
    printf("%s", buf);
}
...
/* from rui.c */
extern int DialogSelectFile(char *buf, int len);
