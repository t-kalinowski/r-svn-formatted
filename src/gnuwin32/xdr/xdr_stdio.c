 ...
 */
void xdrstdio_create(xdrs, file, op) register XDR *xdrs;
FILE *file;
enum xdr_op op;
{
 ...
 */
static void xdrstdio_destroy(xdrs) register XDR *xdrs;
{
...
static bool_t xdrstdio_getbytes(xdrs, addr, len) XDR *xdrs;
caddr_t addr;
u_int len;
{
...
static bool_t xdrstdio_putbytes(xdrs, addr, len) XDR *xdrs;
caddr_t addr;
u_int len;
{
...
static u_int xdrstdio_getpos(xdrs) XDR *xdrs;
{

    return ((u_int)ftell((FILE *)xdrs->x_private));
}

static bool_t xdrstdio_setpos(xdrs, pos) XDR *xdrs;
u_int pos;
{
...
static long *xdrstdio_inline(xdrs, len) XDR *xdrs;
u_int len;
{
