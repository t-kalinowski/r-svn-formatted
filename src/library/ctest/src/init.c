...
R_NativePrimitiveArgType chisqsim_t[11] = {INTSXP,  INTSXP, INTSXP,  INTSXP, INTSXP, INTSXP,
...
R_NativePrimitiveArgType swilk_t[9] = {LGLSXP, SINGLESXP, INTSXP, INTSXP, INTSXP, SINGLESXP, REALSXP, REALSXP, INTSXP};
