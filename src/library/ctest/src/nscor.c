...
void nscor1_(double *s, int *n, int *n2, double *work, int *ifault)
{
...
double correc_(int *i, int *n)
{
    ...
    const float c2[7] = {-6195.f, -9569.f, -6728.f, -17614.f, -8278.f, -3570.f, 1075.f};
    const float c3[7] = {93380.f, 175160.f, 410400.f, 2157600.f, 2.376e6f, 2.065e6f, 2.065e6f};
