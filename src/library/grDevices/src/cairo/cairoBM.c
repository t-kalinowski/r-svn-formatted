...
static void cbm_Size(double *left, double *right, double *bottom, double *top, pDevDesc dd)
{
...
#else
static int R_SaveAsPng(void *d, int width, int height, unsigned int (*gp)(void *, int, int), int bgr, FILE *fp,
                       unsigned int transparent, int res);

static int R_SaveAsJpeg(void *d, int width, int height, unsigned int (*gp)(void *, int, int), int bgr, int quality,
                        FILE *outfile, int res);

static int R_SaveAsTIFF(void *d, int width, int height, unsigned int (*gp)(void *, int, int), int bgr,
                        const char *outfile, int res, int compression);

static int R_SaveAsBmp(void *d, int width, int height, unsigned int (*gp)(void *, int, int), int bgr, FILE *fp,
                       int res);
#endif
...
static int R_SaveAsBmp(void *d, int width, int height, unsigned int (*gp)(void *, int, int), int bgr, FILE *fp, int res)
{
    return 0;
}
