...
{
    return GConvertX(x, GMapUnits(0), GMapUnits(1), GetDevice(ndevNumber(((QuartzDesc *)desc)->dev)));
}
double QuartzDevice_UserY(QuartzDesc_t desc, double y)
{
    return GConvertX(y, GMapUnits(0), GMapUnits(1), GetDevice(ndevNumber(((QuartzDesc *)desc)->dev)));
}
