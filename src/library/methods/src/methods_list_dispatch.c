...
static SEXP s_dot_Methods, s_skeleton, s_expression, s_function, s_getAllMethods, s_objectsEnv, s_MethodsListSelect,
    s_sys_dot_frame, s_sys_dot_call, s_sys_dot_function, s_generic, s_package, s_missing, s_generic_dot_skeleton,
    s_subset_gets, s_element_gets, s_argument, s_allMethods;
...
SEXP R_initMethodDispatch(SEXP envir)
{
    ...
    */
    ...
    UNPROTECT(1);
    PROTECT(R_empty_skeletons = findVar(Rf_install(".EmptyPrimitiveSkeletons"), Methods_Namespace));
