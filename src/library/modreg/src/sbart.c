...
*/
void F77_SUB(sbart)(double *penalt, double *dofoff, double *xs, double *ys, double *ws, double *ssw, long *n,
                    double *knot, long *nk, double *coef, double *sz, double *lev, double *crit, long *icrit,
                    double *spar, long *ispar, long *iter, double *lspar, double *uspar, double *tol, double *eps,
                    long *isetup, double *xwy, double *hs0, double *hs1, double *hs2, double *hs3, double *sg0,
                    double *sg1, double *sg2, double *sg3, double *abd, double *p1ip, double *p2ip, long *ld4,
                    long *ldnk, long *ier)
{
    ...
    else
    {
        ...
        *lspar = ratio * R_pow(16., *spar * 6. - 2.);
        ...
        L50:
            ...
            *lspar = ratio * R_pow(16., *spar * 6. - 2.);
            F77_CALL(sslvrg)
            (penalt, dofoff, xs, ys, ws, ssw, n, knot, nk, coef, sz, lev, crit, icrit, lspar, xwy, hs0, hs1, hs2, hs3,
