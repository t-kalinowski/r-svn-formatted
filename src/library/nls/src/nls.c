...
SEXP nls_iter(SEXP args)
{

    double dev, fac, minFac, tolerance, newDev, convNew;
    int i, j, maxIter, hasConverged, nPars, doTrace;
    SEXP m, control, tmp, conv, incr, deviance, setPars, getPars, pars, newPars, newIncr, trace;
...
SEXP numeric_deriv(SEXP args)
{
    ...
    SEXP theta, expr, rho, ans, ans_del, gradient, pars, gradNames, gradDims, dims, temp;
