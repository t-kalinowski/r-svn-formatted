...
static const R_CallMethodDef callMethods[] = {{"nextStream", (DL_FUNC)&nextStream, 1},
                                              {"nextSubStream", (DL_FUNC)&nextSubStream, 1},
#ifndef WIN32
                                              {"mc_can_disable_quartz", (DL_FUNC)&mc_can_disable_quartz, 0},
                                              ...
                                              {"mc_send_child_stdin", (DL_FUNC)&mc_read_child, 2},
#else
