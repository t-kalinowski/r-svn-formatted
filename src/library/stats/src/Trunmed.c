...
#define Rm_PR(_F_, _A_)                                                                                                \
    for (j = 0; j <= 2 * k; j++)                                                                                       \
    Rprintf(_F_, _A_)
#define RgPRINT_j(A_J)                                                                                                 \
    Rm_PR("%6g", A_J);                                                                                                 \
    Rprintf("\n")
#define RdPRINT_j(A_J)                                                                                                 \
    Rm_PR("%6d", A_J);                                                                                                 \
    Rprintf("\n")
...
void Trunmed(Sint *nn,                           /* = length(data) */
             ...
             Sint *nrlist,                       /* (2k+1) */
             double *window,                     /* (2k+1) */
             Sint *end_rule, Sint *print_level)
{
    int k = (int)*kk, k2 = (k - 1) / 2, /* k == *kk == 2 * k2 + 1 */
        j;
    ...
    runmedint((int)*nn, k, k2, data, median, window, (int *)outlist, (int *)nrlist, (int)*end_rule, (int)*print_level);
}
