...
/* y vector length n of observations
   ...
   No checking here!
 */
SEXP KalmanLike(SEXP sy, SEXP sZ, SEXP sa, SEXP sP, SEXP sT, SEXP sV, SEXP sh, SEXP sPn, SEXP sUP, SEXP op)
{
...
SEXP KalmanSmooth(SEXP sy, SEXP sZ, SEXP sa, SEXP sP, SEXP sT, SEXP sV, SEXP sh, SEXP sPn, SEXP sUP)
{
...
SEXP KalmanFore(SEXP nahead, SEXP sZ, SEXP sa0, SEXP sP0, SEXP sT, SEXP sV, SEXP sh)
{
...
{
    int *arma = INTEGER(sarma), mp = arma[0], mq = arma[1], msp = arma[2], i, v, n = LENGTH(sin);
...
static void inclu2(int np, double *xnext, double *xrow, double ynext, double *d, double *rbar, double *thetab)
{
