...
{
    int *arma = INTEGER(sarma), mp = arma[0], mq = arma[1], msp = arma[2], i, j, v, n = LENGTH(in);
...
SEXP ARIMA_Like(SEXP sy, SEXP sPhi, SEXP sTheta, SEXP sDelta, SEXP sa, SEXP sP, SEXP sPn, SEXP sUP, SEXP giveResid)
{
