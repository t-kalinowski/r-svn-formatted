...
static R_NativePrimitiveArgType fexact_t[11] = {INTSXP,  INTSXP,  INTSXP,  INTSXP, REALSXP, REALSXP,
...
static R_NativePrimitiveArgType swilk_t[6] = {REALSXP, INTSXP, INTSXP, REALSXP, REALSXP, INTSXP};
