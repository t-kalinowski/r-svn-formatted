...
static const R_CMethodDef CEntries[] = {C_DEF(loess_raw, 24),      C_DEF(loess_dfit, 13),  C_DEF(loess_dfitse, 16),
                                        C_DEF(loess_ifit, 8),      C_DEF(loess_ise, 15),   C_DEF(multi_burg, 11),
                                        C_DEF(multi_yw, 10),       C_DEF(HoltWinters, 17), C_DEF(kmeans_Lloyd, 9),
                                        C_DEF(kmeans_MacQueen, 9), C_DEF(rcont2, 8),       {NULL, NULL, 0}};
...
#define CALLDEF_DO(name, n)                                                                                            \
    {                                                                                                                  \
#name, (DL_FUNC)&do_##name, n                                                                                  \
    }
...
static const R_CallMethodDef CallEntries[] = {CALLDEF(cutree, 2),
                                              CALLDEF(isoreg, 1),
                                              CALLDEF(monoFC_m, 2),
...
#define FDEF(name)                                                                                                     \
    {                                                                                                                  \
#name, (DL_FUNC)&F77_NAME(name), sizeof(name##_types) / sizeof(name##_types[0]), name##_types                  \
    }

static R_NativePrimitiveArgType lowesw_types[] = {REALSXP, INTSXP, REALSXP, INTSXP};
static R_NativePrimitiveArgType lowesp_types[] = {INTSXP, REALSXP, REALSXP, REALSXP, REALSXP, INTSXP, REALSXP};
...
static const R_ExternalMethodDef ExtEntries[] = {EXTDEF(compcases, -1),
                                                 EXTDEF(doD, 2),
                                                 EXTDEF(deriv, 5),
                                                 EXTDEF(modelframe, 8),
