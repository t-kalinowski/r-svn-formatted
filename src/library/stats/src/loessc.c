...
static void loess_workspace(int D, int N, double span, int degree, int nonparametric, const int drop_square[],
...
void F77_NAME(lowesd)(int *iv, int *liv, int *lv, double *v, int *d, int *n, double *f, int *ideg, int *nf, int *nvmax,
                      int *setlf);
void F77_NAME(lowese)(int *, double *, int *, double *, double *);
void F77_NAME(lowesf)(double *, double *, double *, int *, double *, int *, double *, double *, int *, double *);
...
void loess_workspace(int D, int N, double span, int degree, int nonparametric, const int drop_square[],
                     int sum_drop_sqr, Rboolean setLf)
{
    int nvmax = max(200, N), nf = min(N, (int)floor(N * span + 1e-5));
    if (nf <= 0)
