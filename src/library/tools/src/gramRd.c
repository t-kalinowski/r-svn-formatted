...
static const yytype_int16 yytoknum[] = {0,   256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270,
...
static const yytype_int8 yyr1[] = {0,  48, 49, 49, 49, 50, 51, 52, 52, 53, 53, 53, 53, 53, 53, 53, 53, 53,
...
static const yytype_int8 yyr2[] = {0, 2, 3, 3, 1, 2, 1, 1, 2, 2, 2, 2, 2, 2, 3,  4,  4, 3, 4, 1, 1, 1, 2,
...
yyreduce:
    ...
    case 58: {
        yyval = xxusermacro(yyvsp[-6], xxnewlist6(yyvsp[-5], yyvsp[-4], yyvsp[-3], yyvsp[-2], yyvsp[-1], yyvsp[0]),
                            &(yyloc));
    }
    break;

    case 59: {
        yyval = xxusermacro(yyvsp[-8],
    ...
    case 60: {
        yyval = xxusermacro(
            yyvsp[-9],
            xxnewlist8(yyvsp[-8], yyvsp[-7], yyvsp[-6], yyvsp[-5], yyvsp[-4], yyvsp[-3], yyvsp[-2], yyvsp[-1]),
            &(yyloc));
    }
    break;
    ...
    case 61: {
        yyval = xxusermacro(yyvsp[-10],
                            xxnewlist9(yyvsp[-9], yyvsp[-8], yyvsp[-7], yyvsp[-6], yyvsp[-5], yyvsp[-4], yyvsp[-3],
                                       yyvsp[-2], yyvsp[-1]),
                            &(yyloc));
    }
    break;
