...
void starma(int p, int q, int r, int np, double *phi, double *theta, double *a, double *P, double *V, double *thetab,
            double *xnext, double *xrow, double *rbar, int nrbar, int *ifault)
{
    int indi, indj, indn;
...
void karma(int p, int q, int r, int np, double *phi, double *theta, double *a, double *P, double *V, int n, double *w,
           double *resid, double *sumlog, double *ssq, int iupd, double delta, int *nit)
{
            ...
            double *resid, double *xnext, double *xrow, double *rbar, double *thetab, double *store, int *ifault)
{
    ...
    *ifault = 0;
    ...
    if (ir == 1)
        ...
        starma(ip, iq, ir, np, &phi[1], theta, &a[1], &p[1], &v[1], thetab, xnext, xrow, rbar, nrbar, ifault);
    ...
    ssq = 0.0;
    nit = 0;
    karma(ip, iq, ir, np, &phi[1], theta, &a[1], &p[1], &v[1], nt, &w[1], resid, &sumlog, &ssq, 1, -1.0, &nit);
