...
void starma(int *p, int *q, int *r, int *np, double *phi, double *theta, double *a, double *P, double *V,
...
void karma(int *p, int *q, int *r, int *np, double *phi, double *theta, double *a, double *P, double *V, int *n,
           double *w, double *resid, double *sumlog, double *ssq, int *iupd, double *delta, int *nit)
{
            ...
            double *resid, double *xnext, double *xrow, double *rbar, double *thetab, double *store, int *ifault)
{
    ...
    *ifault = 0;
    ...
    del = -1.0;
    nit = 0;
    karma(ip, iq, ir, np, &phi[1], theta, &a[1], &p[1], &v[1], &nt, &w[1], resid, &sumlog, &ssq, &iupd, &del, &nit);
