...
typedef pascal void (*SmartScrollProcPtr)(SInt32 selector, SInt32 *result, ControlHandle theScrollBar, SInt32 param1,
                                          SInt32 param2);

enum
{
    uppSmartScrollProcInfo = kPascalStackBased | STACK_ROUTINE_PARAMETER(1, SIZE_CODE(sizeof(SInt32))) |
...
#endif
    {
        if ((Gestalt(gestaltSmartScroll, (SInt32 *)&rec) == noErr) && (rec != nil) &&
...
inline SInt32 __SmartScrollDispatch(SInt32 inSelector, ControlHandle inControl, SInt32 inParam1, SInt32 inParam2)
{
    SInt32 result = 0L;
    ...
    {
#if GENERATINGCFM
        CallUniversalProc(sSmartScrollDispatch, uppSmartScrollProcInfo, inSelector, &result, inControl, inParam1,
                          inParam2);
#else
...
pascal void SetSmartScrollInfo(ControlHandle inScrollBar, SInt32 inAmountVisible, SInt32 inAmountTotal)
{
...
pascal void SetSmartScrollProportion(ControlHandle inScrollBar, Fract inProportion)
{
