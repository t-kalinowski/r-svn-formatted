...
*/
attribute_hidden void *Rf_convertToC(SEXP s, R_CConvertInfo *info, int *success, R_toCConverter **converter)
{
    void *ans;
...
*/
R_toCConverter *R_addToCConverter(R_ToCPredicate matcher, R_ToCConverter converter, R_FromCConverter reverse,
