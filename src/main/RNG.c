...
static DL_FUNC User_unif_fun, User_unif_init, User_unif_nseed, User_unif_seedloc;
...
static RNGTAB RNG_Table[] = {
    ...
    {0, 0, "Wichmann-Hill", 3, dummy},     {1, 0, "Marsaglia-MultiCarry", 2, dummy},
    {2, 0, "Super-Duper", 2, dummy},       {3, 0, "Mersenne-Twister", 1 + 624, dummy},
    {4, 0, "Knuth-TAOCP", 1 + 100, dummy}, {5, 0, "User-supplied", 0, dummy},
};
...
void PutRNGstate()
{
    ...
    if (RNG_kind < 0 || RNG_kind > USER_UNIF || N01_kind < 0 || N01_kind > USER_NORM)
    {
