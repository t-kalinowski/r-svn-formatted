...
#define ALTREP_OBJECT_CLSSYM(x) ALTREP_SERIALIZED_CLASS_CLSSYM(ALTREP_SERIALIZED_CLASS(x))
#define ALTREP_OBJECT_PKGSYM(x) ALTREP_SERIALIZED_CLASS_PKGSYM(ALTREP_SERIALIZED_CLASS(x))
...
#define ALTREP_ERROR_IN_CLASS(msg, x)                                                                                  \
    do                                                                                                                 \
    {                                                                                                                  \
        error("%s [class: %s, pkg: %s]", msg, CHAR(PRINTNAME(ALTREP_OBJECT_CLSSYM(x))),                                \
...
static int altlogical_Elt_default(SEXP x, R_xlen_t i)
{
    return LOGICAL(x)[i];
}
...
static int altlogical_Is_sorted_default(SEXP x)
{
    return UNKNOWN_SORTEDNESS;
}
static int altlogical_No_NA_default(SEXP x)
{
    return 0;
}

static SEXP altlogical_Sum_default(SEXP x, Rboolean narm)
{
    return NULL;
}

static Rbyte altraw_Elt_default(SEXP x, R_xlen_t i)
{
    return RAW(x)[i];
}
...
static altlogical_methods_t altlogical_default_methods = {.UnserializeEX = altrep_UnserializeEX_default,
                                                          .Unserialize = altrep_Unserialize_default,
                                                          .Serialized_state = altrep_Serialized_state_default,
                                                          .DuplicateEX = altrep_DuplicateEX_default,
                                                          .Duplicate = altrep_Duplicate_default,
...
static altraw_methods_t altraw_default_methods = {.UnserializeEX = altrep_UnserializeEX_default,
                                                  .Unserialize = altrep_Unserialize_default,
                                                  .Serialized_state = altrep_Serialized_state_default,
                                                  .DuplicateEX = altrep_DuplicateEX_default,
                                                  .Duplicate = altrep_Duplicate_default,
...
static altcomplex_methods_t altcomplex_default_methods = {.UnserializeEX = altrep_UnserializeEX_default,
                                                          .Unserialize = altrep_Unserialize_default,
                                                          .Serialized_state = altrep_Serialized_state_default,
                                                          .DuplicateEX = altrep_DuplicateEX_default,
                                                          .Duplicate = altrep_Duplicate_default,
...
static R_altrep_class_t make_altrep_class(int type, const char *cname, const char *pname, DllInfo *dll)
{
    ...
    case REALSXP:
        ...
        break;
    case LGLSXP:
        MAKE_CLASS(class, altlogical);
        break;
    case RAWSXP:
        MAKE_CLASS(class, altraw);
        break;
    case CPLXSXP:
        MAKE_CLASS(class, altcomplex);
        break;
    case STRSXP:
...
static void reinit_altrep_class(SEXP class)
{
    ...
    case STRSXP:
        ...
        break;
    case LGLSXP:
        INIT_CLASS(class, altlogical);
        break;
    case RAWSXP:
        INIT_CLASS(class, altraw);
        break;
    case CPLXSXP:
        INIT_CLASS(class, altcomplex);
        break;
    default:
        error("unsupported ALTREP class");
    }
