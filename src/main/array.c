...
static R_INLINE void simple_matprod(double *x, int nrx, int ncx, double *y, int nry, int ncy, double *z)
{
    LDOUBLE sum;
...
static R_INLINE void simple_crossprod(double *x, int nrx, int ncx, double *y, int nry, int ncy, double *z)
{
    LDOUBLE sum;
...
static R_INLINE void simple_tcrossprod(double *x, int nrx, int ncx, double *y, int nry, int ncy, double *z)
{
    LDOUBLE sum;
    R_xlen_t NRX = nrx, NRY = nry;
...
static R_INLINE void simple_cmatprod(Rcomplex *x, int nrx, int ncx, Rcomplex *y, int nry, int ncy, Rcomplex *z)
{
    int i, j, k;
...
static R_INLINE void simple_ccrossprod(Rcomplex *x, int nrx, int ncx, Rcomplex *y, int nry, int ncy, Rcomplex *z)
{
    int i, j, k;
...
static R_INLINE void simple_tccrossprod(Rcomplex *x, int nrx, int ncx, Rcomplex *y, int nry, int ncy, Rcomplex *z)
{
    int i, j, k;
