...
static double complex mycpow(double complex X, double complex Y)
{
    ...
    else if (cimag(Y) == 0.0 && creal(Y) == (k = (int)__real__ Y) && abs(k) <= 65536)
    {
        return R_cpow_n(X, k);
    }
    else
...
SEXP attribute_hidden complex_math1(SEXP call, SEXP op, SEXP args, SEXP env)
{
    ...
    case 20:
        ...
        break;
    case 21:
        naflag = cmath1(csin, COMPLEX(x), COMPLEX(y), n);
        break;
    case 22:
    ...
    case 30:
        ...
        break;
    case 31:
        naflag = cmath1(csinh, COMPLEX(x), COMPLEX(y), n);
        break;
    case 32:
        naflag = cmath1(ctanh, COMPLEX(x), COMPLEX(y), n);
        break;
    case 34:
        naflag = cmath1(casinh, COMPLEX(x), COMPLEX(y), n);
        break;
    case 35:
...
#else
    case 23:
        naflag = cmath1(cacos, COMPLEX(x), COMPLEX(y), n);
        break;
    case 24:
        naflag = cmath1(casin, COMPLEX(x), COMPLEX(y), n);
        break;
    case 33:
        naflag = cmath1(cacosh, COMPLEX(x), COMPLEX(y), n);
        break;
#endif
