...
NORET static size_t null_read(void *ptr, size_t size, size_t nitems, Rconnection con)
{
    error(_("%s not enabled for this connection"), "'read'");
}

NORET static size_t null_write(const void *ptr, size_t size, size_t nitems, Rconnection con)
{
