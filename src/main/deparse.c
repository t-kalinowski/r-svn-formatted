...
SEXP deparse1(SEXP call, Rboolean abbrev, Rboolean forDisplay, Rboolean useSource)
{
    ...
    return (deparse1WithCutoff(call, abbrev, DEFAULT_Cutoff, backtick, forDisplay, useSource));
}
...
SEXP deparse1line(SEXP call, Rboolean abbrev)
{
    ...
    temp = deparse1WithCutoff(call, abbrev, MAX_Cutoff, backtick, forDisplay, useSource);
    return (temp);
}
