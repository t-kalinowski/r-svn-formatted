...
static void PS_Text(double x, double y, int coords, char *str, double rot, DevDesc *dd)
{
    PostScriptDesc *pd = (PostScriptDesc *)dd->deviceSpecific;
...
static void XFig_Rect(double x0, double y0, double x1, double y1, int coords, int bg, int fg, DevDesc *dd)
{
    ...
    FILE *fp = pd->tmpfp;
    int ix0, iy0, ix1, iy1;
    int cbg = XF_SetColor(bg, pd), cfg = XF_SetColor(fg, pd), cpen, dofill, lty = XF_SetLty(pd),
...
static void XFig_Text(double x, double y, int coords, char *str, double rot, DevDesc *dd)
{
    XFigDesc *pd = (XFigDesc *)dd->deviceSpecific;
    FILE *fp = pd->tmpfp;
