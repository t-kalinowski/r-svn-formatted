...
Rboolean internalPicTeXDeviceDriver(NewDevDesc *dd, char *filename, char *bg, char *fg, double width, double height,
                                    Rboolean debug)
{
    picTeXDesc *ptd;
...
Rboolean PicTeXDeviceDriver(DevDesc *dd, char *filename, char *bg, char *fg, double width, double height,
                            Rboolean debug)
{
    return internalPicTeXDeviceDriver((NewDevDesc *)dd, filename, bg, fg, width, height, debug);
}
