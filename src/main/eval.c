...
/* The curren (as of r66652) Windows toolchain compiles explicit sqrt
   ...
   around this. */
#if defined(_WIN32) && !defined(_WIN64) && defined(__GNUC__) && __GNUC__ <= 3 || (__GNUC__ == 4 && __GNUC_MINOR__ < 7)
...
static SEXP bcEval(SEXP body, SEXP rho, Rboolean useCache)
{
    ...
    BEGIN_MACHINE
    {
        ...
        OP(SWAP, 0) :
        {
            ...
            if (MAYBE_REFERENCED(tmp) && (MAYBE_SHARED(tmp) || MAYBE_SHARED(R_BCNodeStackTop[-3])))
