...
#define DO_FAST_BINOP_INT(op, a, b, v)                                                                                 \
    do                                                                                                                 \
    {                                                                                                                  \
...
#define DO_FAST_BINOP(op, a, b, ans)                                                                                   \
    do                                                                                                                 \
    {                                                                                                                  \
        SKIP_OP();                                                                                                     \
        double dval = (a)op(b);                                                                                        \
        ...
        {                                                                                                              \
            ...
            SETSTACK_REAL(-2, dval);                                                                                   \
        R_BCNodeStackTop--;                                                                                            \
        NEXT();                                                                                                        \
    } while (0)

#define DO_FAST_BINOP_INT(op, a, b, ans)                                                                               \
    do                                                                                                                 \
    {                                                                                                                  \
        double dval = ((double)(a))op((double)(b));                                                                    \
        if (dval <= INT_MAX && dval >= INT_MIN + 1)                                                                    \
