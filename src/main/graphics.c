...
static Rboolean CSclipline(double *x1, double *y1, double *x2, double *y2, int *clipped1, int *clipped2, int coords,
                           cliprect *cr)
{
    int c, c1, c2;
    double x, y;
...
void GBox(int which, DevDesc *dd)
{
    ...
    case 1: /* Plot */
        ...
        case 'N': /* nothing */
            break;
        default:
            warning("invalid par(\"bty\") = '%c'; no box() drawn.", dd->gp.bty);
        }
        break;
    case 2: /* Figure */
        GPolygon(4, x, y, NFC, NA_INTEGER, dd->gp.col, dd);
