...
int cross(Edge b, double x1, double y1, double x2, double y2, GClipRect *clip)
{
 ...
 */
static void clipPolygon(int n, double *x, double *y, int coords, int bg, int fg, DevDesc *dd)
{
    char *vmax;
    double *xc, *yc;
    if (bg == NA_INTEGER)
...
/* draw a circle */
static void clipCircle(double x, double y, int coords, double r, int bg, int fg, DevDesc *dd)
{
        ...
        else
        {
            ...
            else
            {
                ...
                if (npts > 1)
                {
                    ...
                    npts = GClipPolygon(xc, yc, numvert, coords, 1, xcc, ycc, dd);
...
/* Filled with color bg and outlined with color fg  */
/* These may both be NA_INTEGER	 */
static void clipRect(double x0, double y0, double x1, double y1, int coords, int bg, int fg, DevDesc *dd)
{
    char *vmax;
    double *xc, *yc;
    vmax = vmaxget();
...
#else
#define GSTR_0                                                                                                         \
    0.12 * dd->gp.cex /* NOTE: This cex is already                                                                     \
         multiplied with cexbase */
