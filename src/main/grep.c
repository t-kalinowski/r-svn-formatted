...
static SEXP do_pgsub(SEXP pat, SEXP rep, SEXP text, int global, int igcase_opt, int useBytes)
{
    SEXP ans;
...
SEXP attribute_hidden do_regexpr(SEXP call, SEXP op, SEXP args, SEXP env)
{
    ...
    regex_t reg;
    regmatch_t regmatch[10];
    int i, n, st, igcase_opt, perl_opt, fixed_opt, useBytes, cflags = 0, erroffset;
    int rc, ovector[3];
