...
static void prepare_pcre(const char *pattern, int options, SEXP subject, Rboolean always_study,
...
static char *pcre_string_adj(char *target, const char *orig, const char *repl, int *ovec, Rboolean use_UTF8)
{
    int i, k, nb;
    const char *p = repl;
    char *t = target, c;
