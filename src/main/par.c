...
static void Specify(char *what, SEXP value, DevDesc *dd, SEXP call)
{
    ...
    else if (streql(what, "usr"))
    {
        ...
        else
        {
            ...
            Rf_gpptr(dd)->logusr[0] = Rf_dpptr(dd)->logusr[0] = R_Log10(REAL(value)[0]);
            Rf_gpptr(dd)->logusr[1] = Rf_dpptr(dd)->logusr[1] = R_Log10(REAL(value)[1]);
        }
        if (Rf_gpptr(dd)->ylog)
        {
        ...
        else
        {
            ...
            Rf_gpptr(dd)->logusr[2] = Rf_dpptr(dd)->logusr[2] = R_Log10(REAL(value)[2]);
            Rf_gpptr(dd)->logusr[3] = Rf_dpptr(dd)->logusr[3] = R_Log10(REAL(value)[3]);
        }
