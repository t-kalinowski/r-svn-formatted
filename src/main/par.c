...
static int Specify(char *what, SEXP value, DevDesc *dd)
{
    ...
    else if (streql(what, "usr"))
    {
        ...
        else
        {
            ...
            dd->gp.logusr[0] = dd->dp.logusr[0] = Log10(REAL(value)[0]);
            dd->gp.logusr[1] = dd->dp.logusr[1] = Log10(REAL(value)[1]);
        }
        if (dd->gp.ylog)
        {
        ...
        else
        {
            ...
            dd->gp.logusr[2] = dd->dp.logusr[2] = Log10(REAL(value)[2]);
            dd->gp.logusr[3] = dd->dp.logusr[3] = Log10(REAL(value)[3]);
        }
