...
static BBOX DrawBBox(BBOX bbox, double xoffset, double yoffset, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderOffsetElement(SEXP, double, double, int, mathContext *, pGEcontext, pGEDevDesc);
...
static BBOX RenderItalicCorr(BBOX bbox, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderGap(double gap, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    if (draw)
        PMoveAcross(gap, mc);
...
static BBOX RenderSymbolStr(const char *str, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    char chr[7] = "";
    const char *s = str;
    BBOX glyphBBox;
...
static BBOX RenderChar(int ascii, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
    char asciiStr[7];
...
static BBOX RenderStr(const char *str, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderSymbol(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    int code;
...
static BBOX RenderSymbolString(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    int code;
    if ((code = TranslatedSymbol(expr)))
        return RenderSymbolChar(code, draw, mc, gc, dd);
...
static BBOX RenderNumber(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
...
static BBOX RenderString(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderDots(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderAtom(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    if (NameAtom(expr))
    {
        if (DotsAtom(expr))
...
static BBOX RenderSpace(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderSlash(int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
#ifdef SLASH0
...
static BBOX RenderBin(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderSub(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderSup(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderWideTilde(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    double savedX = mc->CurrentX;
    double savedY = mc->CurrentY;
...
static BBOX RenderWideHat(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    double savedX = mc->CurrentX;
    double savedY = mc->CurrentY;
    BBOX bbox = RenderElement(CADR(expr), draw, mc, gc, dd);
...
static BBOX RenderBar(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    double savedX = mc->CurrentX;
    double savedY = mc->CurrentY;
    BBOX bbox = RenderElement(CADR(expr), draw, mc, gc, dd);
...
static BBOX RenderAccent(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    SEXP body, accent;
    double savedX = mc->CurrentX;
    double savedY = mc->CurrentY;
...
static void NumDenomVShift(BBOX numBBox, BBOX denomBBox, double *u, double *v, mathContext *mc, pGEcontext gc,
                           pGEDevDesc dd)
{
...
static BBOX RenderFraction(SEXP expr, int rule, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderUnderline(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    SEXP body = CADR(expr);
    BBOX BBox;
...
static BBOX RenderOver(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderUnderl(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderAtop(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderDelimiter(int delim, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
    double savecex = gc->cex;
...
static BBOX RenderGroup(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderDelim(int which, double dist, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    double savedX = mc->CurrentX;
    double savedY = mc->CurrentY;
...
static BBOX RenderBGroup(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    double dist;
    BBOX bbox;
    double axisHeight = TeX(sigma22, gc, dd);
...
static BBOX RenderParen(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
...
static BBOX RenderIntSymbol(int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    double savedX = mc->CurrentX;
    double savedY = mc->CurrentY;
...
static BBOX RenderInt(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderOpSymbol(SEXP op, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
    double cexSaved = gc->cex;
    /*double savedX = mc->CurrentX;*/
...
static BBOX RenderOp(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderScript(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
    STYLE style = GetStyle(mc);
    SetSupStyle(style, mc, gc);
...
static BBOX RenderRadical(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    SEXP body = CADR(expr);
...
static BBOX RenderAbs(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderCurly(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderRel(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderBold(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
...
static BBOX RenderItalic(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
...
static BBOX RenderPlain(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
...
static BBOX RenderSymbolFace(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
...
static BBOX RenderBoldItalic(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
...
static BBOX RenderStyle(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderPhantom(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox = RenderElement(CADR(expr), 0, mc, gc, dd);
...
static BBOX RenderConcatenate(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox = NullBBox();
    int i, n;
...
static BBOX RenderCommaList(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox = NullBBox();
...
static BBOX RenderList(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
...
static BBOX RenderFormula(SEXP expr, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    SEXP head = CAR(expr);
...
static BBOX RenderOffsetElement(SEXP expr, double x, double y, int draw, mathContext *mc, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
    double savedX = mc->CurrentX;
    double savedY = mc->CurrentY;
...
double GEExpressionWidth(SEXP expr, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
    double width;
...
double GEExpressionHeight(SEXP expr, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
    double height;
...
void GEMathText(double x, double y, SEXP expr, double xc, double yc, double rot, pGEcontext gc, pGEDevDesc dd)
{
    BBOX bbox;
    mathContext mc;
