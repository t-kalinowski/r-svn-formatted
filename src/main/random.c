...
static Rboolean random2(double (*f)(double, double), double *a, R_xlen_t na, double *b, R_xlen_t nb, double *x,
                        R_xlen_t n)
{
    double ai, bi;
    R_xlen_t i;
...
static Rboolean random3(double (*f)(double, double, double), double *a, R_xlen_t na, double *b, R_xlen_t nb, double *c,
                        R_xlen_t nc, double *x, R_xlen_t n)
{
    double ai, bi, ci;
    R_xlen_t i;
    Rboolean naflag = FALSE;
