...
R_NativePrimitiveArgType loglin_t[] = {INTSXP,  INTSXP, INTSXP,  INTSXP,  INTSXP, REALSXP, REALSXP, INTSXP, INTSXP,
                                       REALSXP, INTSXP, REALSXP, REALSXP, INTSXP, REALSXP, INTSXP,  INTSXP};

R_NativePrimitiveArgType lowess_t[] = {REALSXP, REALSXP, INTSXP, REALSXP, INTSXP, REALSXP, REALSXP, REALSXP, REALSXP};
...
R_NativePrimitiveArgType spline_eval_t[] = {INTSXP,  INTSXP,  REALSXP, REALSXP, INTSXP,
...
R_NativePrimitiveArgType fft_work_t[] = {
    REALSXP,
    REALSXP,
};
...
R_FortranMethodDef fortranMethods[] = {
    /* Linpack */
    FDEF(ch2inv), FDEF(chol),   FDEF(cg),    FDEF(ch),    FDEF(rg),     FDEF(rs),     FDEF(dchdc),
    FDEF(dpbfa),  FDEF(dpbsl),  FDEF(dpoco), FDEF(dpodi), FDEF(dpofa),  FDEF(dposl),  FDEF(dqrcf),
