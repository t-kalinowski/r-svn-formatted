...
OutVec(Integer, INTEGER, Integer, INTEGER, int) OutVec(Real, REAL, Double, DOUBLE, double)
...
InVec(Integer, INTEGER, Integer, INTEGER, int) InVec(Real, REAL, Double, DOUBLE, double)
