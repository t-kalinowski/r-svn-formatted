...
static void point_computing(double *A_blend, double *px, double *py, double *x, double *y)
{
    double weights_sum;
...
static float step_computing(int k, double *px, double *py, double s1, double s2, float precision, pGEDevDesc dd)
{
     ...
     * device.
     */
    devWidth = fromDeviceWidth(toDeviceWidth(1, GE_NDC, dd), GE_INCHES, dd) * 1200;
    devHeight = fromDeviceHeight(toDeviceHeight(1, GE_NDC, dd), GE_INCHES, dd) * 1200;
