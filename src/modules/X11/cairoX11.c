...
static void text_extents(cairo_t *cc, PangoLayout *layout, gint *lbearing, gint *rbearing, gint *width, gint *ascent,
                            ...
                            pDevDesc dd)
{
    ...
    if (R_ALPHA(gc->col) > 0)
    {
        ...
        cairo_save(xd->cc);
        layout = layoutText(desc, xd->cc, str);
        text_extents(xd->cc, layout, &lbearing, NULL, &width, &ascent, NULL, 0);
