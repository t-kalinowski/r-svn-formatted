...
Rboolean newX11DeviceDriver(DevDesc *dd, char *disp_name, double width, double height, double pointsize,
                            double gamma_fac, X_COLORTYPE colormodel, int maxcube, int canvascolor)
{
    newX11Desc *xd;
...
void R_init_X11(DllInfo *info)
{
     ...
     */
    R_setX11Routines((R_X11DeviceDriverRoutine)newX11DeviceDriver, RX11_dataentry, R_GetX11Image);
}
