...
static void help_about_cb(GtkWidget *widget, gpointer data)
{
    ...
    about_box = gnome_about_new("R", version, copyright, authors,
                                ...
                                "similar to S, which was developed at Bell Laboratories by John Chambers et al. It "
                                "provides a wide variety of statistical and graphical techniques (linear and nonlinear "
                                "modelling, statistical tests, time series analysis, classification, clustering, ...).",
                                "R-logo-sm.xpm");

    hbox = gtk_hbox_new(TRUE, 0);
    home_href = gnome_href_new("http://www.r-project.org/", "R home page");
    FAQ_href = gnome_href_new("http://cran.r-project.org/doc/FAQ/R-FAQ.html", "R FAQ");
...
static void generic_cb(GtkWidget *widget, gpointer data)
{
    ...
    dialog = gnome_message_box_new("This menu item is currently unimplemented", GNOME_MESSAGE_BOX_INFO,
...
static GnomeUIInfo file_menu[] = {
    {GNOME_APP_UI_ITEM, "_Open...", "Open a saved workspace image", (gpointer)R_gtk_terminal_file_open, NULL, NULL,
     GNOME_APP_PIXMAP_STOCK, GNOME_STOCK_MENU_OPEN, GNOME_KEY_NAME_OPEN, GNOME_KEY_MOD_NEW, NULL},
    {GNOME_APP_UI_ITEM, "Save", "Save the workspace image", (gpointer)R_gtk_terminal_file_save, NULL, NULL,
     GNOME_APP_PIXMAP_STOCK, GNOME_STOCK_MENU_SAVE, GNOME_KEY_NAME_SAVE, GNOME_KEY_MOD_SAVE, NULL},
    {GNOME_APP_UI_ITEM, "Save _As...", "Save the workspace image to a file", (gpointer)R_gtk_terminal_file_saveas, NULL,
     NULL, GNOME_APP_PIXMAP_STOCK, GNOME_STOCK_MENU_SAVE_AS, GNOME_KEY_NAME_SAVE_AS, GNOME_KEY_MOD_SAVE_AS, NULL},
    GNOMEUIINFO_SEPARATOR,
    {GNOME_APP_UI_ITEM, "_Print...", "Print the console output", (gpointer)generic_cb, NULL, NULL,
     GNOME_APP_PIXMAP_STOCK, GNOME_STOCK_MENU_PRINT, 0, (GdkModifierType)0, NULL},
...
static GnomeUIInfo graphics_menu[] = {
    ...
    GNOMEUIINFO_ITEM_NONE("Close _All Devices", "Close all graphics devices", graphics_closeall_cb), GNOMEUIINFO_END};

static GnomeUIInfo commands_menu[] = {
    {GNOME_APP_UI_ITEM, "_Interrupt", "Interrupt R processing (SIGTERM)", (gpointer)commands_interrupt_cb, NULL, NULL,
    ...
    GNOMEUIINFO_SEPARATOR,
    GNOMEUIINFO_ITEM_NONE("grep...", "Search for matches to a regular expression within a vector of character strings",
                          commands_grep_cb),
...
static GnomeUIInfo windows_menu[] = {GNOMEUIINFO_END};
