...
void terminal_set_style(void)
{
    ...
    gtk_object_set(GTK_OBJECT(R_gtk_terminal_text), "output_color_gdk", prefs_get_console_outputcolor(),
                   "input_color_gdk", prefs_get_console_textcolor(), "bg_color_gdk", prefs_get_console_bgcolor(),
                   "font", prefs_get_console_font(), NULL);
}
