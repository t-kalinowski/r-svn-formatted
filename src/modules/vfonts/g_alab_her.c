...
/* this is the version of the flabelwidth() method that is specific to the
   ...
   g_flabelwidth () */
static double GVStrWidth(const unsigned char *s, int typeface, int fontindex, int unit, DevDesc *dd)
{
    double label_width;
...
static double GVStrHeight(const unsigned char *s, int typeface, int fontindex, int unit, DevDesc *dd)
{
    double label_height;
    unsigned short *codestring;
...
static void GVText(double x, double y, int unit, char *s, int typeface, int fontindex, double x_justify,
