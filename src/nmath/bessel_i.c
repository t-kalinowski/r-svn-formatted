...
void I_bessel(double *x, double *alpha, long *nb, long *ize, double *b, long *ncalc)
{
    /* -------------------------------------------------------------------
    ...
    */
    ...
    double pold, test, p, em, en, empal, emp2al, halfx, tempa, tempb, tempc, psave, plast, tover, psavel, sum;
