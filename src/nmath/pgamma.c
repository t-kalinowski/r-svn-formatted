 ...
 * (cd ~/R/D/r-devel/Linux-inst/src/nmath; gcc -std=gnu99 -I. -I../../src/include -I../../../R/src/include
 *-I/usr/local/include -DDEBUG_p -g -O2 -c ../../../R/src/nmath/pgamma.c -o pgamma.o)
 */
...
static double ppois_asymp(double x, double lambda, int lower_tail, int log_p)
{
    ...
    static const double coefs_b[8] = {-1e99, /* placeholder */
                                      1 / 12.,
                                      1 / 288.,
                                      -139 / 51840.,
                                      -571 / 2488320.,
