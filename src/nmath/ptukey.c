...
static double wprob(double w, double rr, double cc)
{
    ...
    static double aleg[ihalf] = {0.047175336386511827194615961485, 0.106939325995318430960254718194,
    ...
    double a, ac, ans, b, binc, blb, bub, c, cc1, einsum, elsum, pminus, pplus, qexpo, qsqz, rinsum, wi, wincr, xx;
    int j, jj;
...
double ptukey(double q, double rr, double cc, double df)
{
    ...
    static double alegq[ihalfq] = {0.271524594117540948517805724560e-01, 0.622535239386478928628438369944e-01,
