...
static double wprob(double w, double rr, double cc)
{
    ...
    */
    ...
    const static double xleg[ihalf] = {0.981560634246719250690549090149e0, 0.904117256370474856678465866119e0,
    ...
    const static double aleg[ihalf] = {0.047175336386511827194615961485, 0.106939325995318430960254718194,
    ...
    double a, ac, wprob, b, binc, blb, bub, c, cc1, einsum, elsum, pminus, pplus, qexpo, qsqz, rinsum, wi, wincr, xx;
    int j, jj;
...
double ptukey(double q, double rr, double cc, double df, int lower_tail, int log_p)
{
    ...
    const static double xlegq[ihalfq] = {0.989400934991649932596154173450e+00, 0.944575023073232576077988415535e+00,
                                         ...
                                         0.281603550779258913230460501460e+00, 0.950125098376374401853193354250e-01};
    const static double alegq[ihalfq] = {0.271524594117540948517805724560e-01, 0.622535239386478928628438369944e-01,
                                         0.951585116824927848099251076022e-01, 0.124628971255533872052476282192e+00,
