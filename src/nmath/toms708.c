...
static double bfrac(double a, double b, double x, double y, double lambda, double eps)
{
    ...
    /* Local variables */
    double c__, e, n, p, r__, s, t, w, c0, c1, r0, an, bn, yp1, anp1, bnp1, beta, alpha;
...
static double basym(double a, double b, double lambda, double eps)
{
    ...
    int i__, j, m, n;
    double r__, s, t, u, w, z__, a0[21], b0[21], j0, j1, h2, r0, r1, t0, t1, w0, z0, z2, hn, zn;
...
double rexpm1(double x)
{
    ...
    ret_val = x * (((p2 * x + p1) * x + 1.0) / ((((q4 * x + q3) * x + q2) * x + q1) * x + 1.0));
    return ret_val;
...
static double erf__(double x)
{
    ...
    static double q[8] = {1.,
                          ...
                          790.950925327898,
                          300.459260956983};
    static double r__[5] = {2.10144126479064, 26.2370141675169, 21.3688200555087, 4.6580782871847, .282094791773523};
...
static double gam1(double a)
{
    ...
    static double q[5] = {1., .427569613095214, .158451672430138, .0261132021441447, .00423244297896961};
    static double r__[9] = {-.422784335098468,  -.771330383816272,   -.244757765222226,
...
L30:
    top = (((((((r__[8] * t + r__[7]) * t + r__[6]) * t + r__[5]) * t + r__[4]) * t + r__[3]) * t + r__[2]) * t +
           r__[1]) *
              t +
          r__[0];
    bot = (s2 * t + s1) * t + 1.0;
