 ...
 *MM: (cd ~/R/D/r-devel/Linux-inst/src/nmath ; gcc -std=gnu99 -I. -I../../src/include -I../../../R/src/include
 *-I/usr/local/include -DHAVE_CONFIG_H -DDEBUG_bratio -g  -c ../../../R/src/nmath/toms708.c -o toms708.o)
 */
#ifdef DEBUG_bratio
...
static void bgrat(double a, double b, double x, double y, double *w, double eps, int *ierr)
{
    ...
    z = -nu * lnx;
    if (b * z == 0.0)
        goto L_Error; /* should *never* happen */
