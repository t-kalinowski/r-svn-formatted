...
DL_FUNC ptr_do_wsbrowser, ptr_GetQuartzParameters, ptr_Raqua_Edit, ptr_do_dataentry, ptr_do_browsepkgs,
    ptr_do_datamanger, ptr_do_packagemanger, ptr_do_flushconsole, ptr_do_hsbrowser, ptr_showarrow, ptr_hidearrow;
...
/* cannot use computeDLOpenFlag as warnings will crash R at this stage */
    ...
    if (!ptr_showarrow)
        R_Suicide("Cannot load Raqua_showarrow");
    ptr_hidearrow = Rdlsym(handle, "Raqua_hidearrow");
    if (!ptr_hidearrow)
        R_Suicide("Cannot load Raqua_hidearrow");
