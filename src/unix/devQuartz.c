...
Rboolean QuartzDeviceDriver(DevDesc *dd, char *display, double width, double height, double pointsize, char *family,
                            Rboolean antialias, Rboolean autorefresh);
...
static void Quartz_Size(double *left, double *right, double *bottom, double *top, NewDevDesc *dd);
...
static double Quartz_StrWidth(char *str, int font, double cex, double ps, NewDevDesc *dd);
static void Quartz_Text(double x, double y, char *str, double rot, double hadj, int col, double gamma, int font,
...
static void Quartz_Polygon(int n, double *x, double *y, int col, int fill, double gamma, int lty, double lwd,
                           NewDevDesc *dd);
...
static void Quartz_MetricInfo(int c, int font, double cex, double ps, double *ascent, double *descent, double *width,
                              NewDevDesc *dd);
...
typedef int (*QuartzAddArcFuncPtr)(CGContextRef ctx, float x, float y, float radius, float startAngle, float endAngle,
                                   int clockwise);
...
Boolean CanInitCoreGraphics(void)
{
    ...
    QuartzBeginPath = (QuartzBeginPathFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextBeginPath"));

    QuartzAddLines = (QuartzAddLinesFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextAddLines"));

    QuartzScaleCTM = (QuartzScaleCTMFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextScaleCTM"));

    QuartzTranslateCTM =
        (QuartzTranslateCTMFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextTranslateCTM"));

    QuartzContextForPort =
        (QuartzContextForPortFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CreateCGContextForPort"));

    QuartzSetLineWidth =
        (QuartzSetLineWidthFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSetLineWidth"));

    QuartzSetLineCap =
        (QuartzSetLineCapFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSetLineCap"));

    QuartzSetLineJoin =
        (QuartzSetLineJoinFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSetLineJoin"));

    QuartzSetRGBFill =
        (QuartzSetRGBFillFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSetRGBFillColor"));

    QuartzSetRGBStroke =
        (QuartzSetRGBStrokeFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSetRGBStrokeColor"));

    QuartzStrokePath =
        (QuartzStrokePathFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextStrokePath"));

    QuartzFlush = (QuartzFlushFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextFlush"));

    QuartzRelease = (QuartzReleaseFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextRelease"));

    QuartzFillRect = (QuartzFillRectFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextFillRect"));

    QuartzFillPath = (QuartzFillPathFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextFillPath"));

    QuartzSync = (QuartzSyncFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSynchronize"));

    QuartzAddArc = (QuartzAddArcFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextAddArc"));

    QuartzClosePath = (QuartzClosePathFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextClosePath"));

    QuartzSetLineDash =
        (QuartzSetLineDashFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSetLineDash"));

    QuartzShowTextAtPoint =
        (QuartzShowTextAtPointFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextShowTextAtPoint"));

    QuartzSelectFont =
        (QuartzSelectFontFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSelectFont"));

    QuartzSetTextDrawingMode = (QuartzSetTextDrawingModeFuncPtr)CFBundleGetFunctionPointerForName(
        sysBundle, CFSTR("CGContextSetTextDrawingMode"));

    QuartzSaveGState =
        (QuartzSaveGStateFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSaveGState"));

    QuartzRestoreGState =
        (QuartzRestoreGStateFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextRestoreGState"));

    QuartzRotateCTM = (QuartzRotateCTMFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextRotateCTM"));

    QuartzGetTextPosition =
        (QuartzGetTextPositionFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextGetTextPosition"));

    QuartzAntialias =
        (QuartzAntialiasFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextSetShouldAntialias"));

    QuartzStrokeRect =
        (QuartzStrokeRectFuncPtr)CFBundleGetFunctionPointerForName(sysBundle, CFSTR("CGContextStrokeRect"));

    if ((QuartzAddLines == nil) || (QuartzBeginPath == nil) || (QuartzScaleCTM == nil) || (QuartzTranslateCTM == nil) ||
        (QuartzContextForPort == nil) || (QuartzSetLineWidth == nil) || (QuartzSetLineCap == nil) ||
        (QuartzSetLineJoin == nil) || (QuartzSetRGBFill == nil) || (QuartzSetRGBStroke == nil) ||
        (QuartzStrokePath == nil) || (QuartzFlush == nil) || (QuartzRelease == nil) || (QuartzFillRect == nil) ||
        (QuartzFillPath == nil) || (QuartzSync == nil) || (QuartzAddArc == nil) || (QuartzClosePath == nil) ||
        (QuartzSetLineDash == nil) || (QuartzShowTextAtPoint == nil) || (QuartzSelectFont == nil) ||
        (QuartzSetTextDrawingMode == nil) || (QuartzSaveGState == nil) || (QuartzRestoreGState == nil) ||
        (QuartzRotateCTM == nil) || (QuartzGetTextPosition == nil) || (QuartzAntialias == nil) ||
        (QuartzStrokeRect == nil))
        return (false);
...
void (*QuartzSetRGBStroke)(CGContextRef c, float red, float green, float blue,
                           float alpha) = CGContextSetRGBStrokeColor;
...
void (*QuartzAddArc)(CGContextRef c, float x, float y, float radius, float startAngle, float endAngle,
                     int clockwise) = CGContextAddArc;
...
void (*QuartzShowTextAtPoint)(CGContextRef c, float x, float y, const char *string,
                              size_t length) = CGContextShowTextAtPoint;
void (*QuartzSelectFont)(CGContextRef c, const char *name, float size,
                         CGTextEncoding textEncoding) = CGContextSelectFont;
...
SEXP do_Quartz(SEXP call, SEXP op, SEXP args, SEXP env)
{
    ...
    BEGIN_SUSPEND_INTERRUPTS
    {
        ...
        if (!QuartzDeviceDriver((DevDesc *)dev, display, width, height, ps, family, antialias, autorefresh))
        {
            free(dev);
...
Rboolean QuartzDeviceDriver(DevDesc *dd, char *display, double width, double height, double pointsize, char *family,
                            Rboolean antialias, Rboolean autorefresh)
{
    return innerQuartzDeviceDriver((NewDevDesc *)dd, display, width, height, pointsize, family, antialias, autorefresh);
}
...
static Rboolean Quartz_Open(NewDevDesc *dd, QuartzDesc *xd, char *dsp, double wid, double hgt)
{
...
static void Quartz_SetStroke(int color, double gamma, NewDevDesc *dd)
{
    ...
    QuartzSetRGBStroke(xd->context, (float)R_RED(color) / 255.0, (float)R_GREEN(color) / 255.0,
...
static void Quartz_SetFill(int fill, double gamma, NewDevDesc *dd)
{
    ...
    QuartzSetRGBFill(xd->context, (float)R_RED(fill) / 255.0, (float)R_GREEN(fill) / 255.0, (float)R_BLUE(fill) / 255.0,
                     alpha);
}
