...
static void GTK_Text(double x, double y, int coords, char *str, double rot, double hadj, DevDesc *dd)
{
    gtkDesc *gtkd = (gtkDesc *)dd->deviceSpecific;
    GdkColor gcol_fill;
    gint size;
...
static gboolean locator_button_press(GtkWidget *widget, GdkEventButton *event, gpointer user_data)
{
