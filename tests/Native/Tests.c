...
static void testStrings(char **vals, long *len)
{
    int i;
    for (i = 0; i < *len; i++)
    {
...
/*
  ...
  into the
 */
static void setNumeric(double *vals, long *len)
{
    int i;
    for (i = 0; i < *len; i++)
    {
...
static void testSingles(float *vals, long *len)
{
    int i;
    for (i = 0; i < *len; i++)
    {
...
static void testList(void *vals, long *len)
{
    int i;
    for (i = 0; i < *len; i++)
    {
...
void R_init_Tests(DllInfo *dll)
{
    const R_CMethodDef cmethods[] = {{"testStrings", (DL_FUNC)&testStrings, 2, stringArgs_t, stringStyles_t},
